"""
Django settings for hch_site project.
...
SECRET_KEY = 'django-insecure-i@obw-0ho^g8=m%(vk=5qrg%#s(z0am35ycqe-umgf4fogig0-'
...
WSGI_APPLICATION = 'hch_site.wsgi.application'
...
LANGUAGE_CODE = 'ka'  # Default language code
